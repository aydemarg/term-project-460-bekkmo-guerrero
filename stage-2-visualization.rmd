...
# -----------------------------------
# Aggregate Olympic medals by country
# -----------------------------------

medals_map <- olympics_final %>%
  group_by(country) %>%
...
# -----------------------------------
# Fix country names to improve matching
# -----------------------------------

medals_map <- medals_map %>%
  mutate(
    country = case_when(
...
world_medals <- world %>%
  left_join(medals_map_clean, by = c("name" = "country"))
